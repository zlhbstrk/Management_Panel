<header class="slidePanel-header">
  <div class="slidePanel-actions" aria-label="actions" role="group">
    <button type="button" class="btn btn-icon btn-pure btn-inverse slidePanel-close actions-top icon md-close"
      aria-hidden="true"></button>
    <div class="btn-group actions-bottom btn-group-flat" role="group">
      <div class="float-left" style="position:relative;">
        <button type="button" class="btn btn-icon btn-pure btn-inverse icon md-more" data-toggle="dropdown"
      ...
      <button type="button" class="btn btn-icon btn-pure btn-inverse icon md-chevron-left"
        aria-hidden="true"></button>
      <button type="button" class="btn btn-icon btn-pure btn-inverse icon md-chevron-right"
        aria-hidden="true"></button>
    </div>
  </div>
    ...
    <div class="mail-header">
      <div class="mail-header-main">
        ...
        <div><a href="javascript:void(0)">Mazhesee@gmail.com</a> to <a href="javascript:void(0)">me</a>
          <span
            class="identity"><i class="md-circle font-size-10 red-600" aria-hidden="true"></i>Work</span>
        </div>
      </div>
