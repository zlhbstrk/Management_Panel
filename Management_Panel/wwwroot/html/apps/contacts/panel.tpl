<header class="slidePanel-header overlay" style="background-image: url('../../../global/photos/placeholder.png');')">
  <div class="overlay-panel overlay-background vertical-align">
    ...
    <div class="vertical-align-middle">
      ...
      <div class="tags">
        <button type="button" class="btn btn-inverse">Desginer</button>
        <button type="button" class="btn btn-inverse">UI</button>
        <button type="button" class="btn btn-inverse">Rocker</button>
      </div>
    </div>
    <button type="button" class="edit btn btn-success btn-floating" data-toggle="edit">
      ...
      <i class="icon md-close animation-scale-up" aria-hidden="true"></i>
    </button>
  </div>
</header>
