    ...
    <div class="slidePanel-actions btn-group btn-group-flat" aria-label="actions" role="group">
      ...
      <div class="dropdown float-left">
        ...
        <div class="dropdown-menu dropdown-menu-right bullet" role="menu">
          <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i class="icon md-edit" aria-hidden="true"></i>Edit Task</a>
...
<div class="slidePanel-inner">
  <section class="slidePanel-inner-section">
    ...
    <div class="task-section attachments">
      <label><i class="icon md-attachment-alt mr-10"></i>Attachments | <a href="#">Download All</a></label>
      <ul class="list-group attachments-list"></ul>
    </div>
  </section>
  <section class="slidePanel-inner-section">
    <div class="comments">
      <label><i class="icon md-comments mr-10"></i>Comments</label>
        ...
        <div class="media-body">
          <div class="comment-body">
            <form class="comment-reply mt-5" method="post" action="#">
              <textarea class="form-control mb-15" placeholder="Reply" rows="4"></textarea>
